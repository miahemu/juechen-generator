...
public class TemplateMaker {
    ...
    public static void main(String[] args) {
        ...
        String inputFilePath = "src/com/juechen/acm/MainTemplate.java";
...
//        String searchStr = "求和结果:";
        ...
        long id = makeTemplate(meta, originProjectPath, inputFilePath, modelInfo, searchStr, 1857104799317770240L);
